...
public class TxHandler {
    ...
    public UTXOPool getUTXOPool() { return _pool; }
    ...
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
        ...
        // System.out.println("possibleTxs[0] inputs: " + possibleTxs[0].getInputs().size() );
        // System.out.println("possibleTxs[0] outputs: " + possibleTxs[0].getOutputs().size() );
        for (int i = 0; i < possibleTxs.length; ++i) {
            // System.out.println("possibleTxs[i].isCoinbase(): " + possibleTxs[i].isCoinbase() );
