...
public class Main {
   ...
   public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
	...
	BlockHandler bh = new BlockHandler(bc);
        // System.out.println("GENESIS> " + DatatypeConverter.printHexBinary(genesis.getHash()));
	...
	block1.finalize();
        ...
        // System.out.println("block1> " + DatatypeConverter.printHexBinary(block1.getHash()));
	...
	block2.finalize();
        ...
        // System.out.println("block2> " + DatatypeConverter.printHexBinary(block2.getHash()));
